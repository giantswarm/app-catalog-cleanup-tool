...
def test_run_catalog_cleanup(mocker: MockerFixture, test_index_yaml: str):  # noqa: F811
    ...
    async_open_mock = cast(
        mocker.AsyncMock, app_catalog_cleanup_tool.__main__.aiofiles.open
    )
    ...
    cast(
        mocker.Mock, app_catalog_cleanup_tool.__main__.shutil.move
    ...
    aio_remove_mock = cast(
        mocker.AsyncMock, app_catalog_cleanup_tool.__main__.aiofiles.os.remove
    )
    ...
    cast(
        mocker.MagicMock, app_catalog_cleanup_tool.__main__.shutil.rmtree
